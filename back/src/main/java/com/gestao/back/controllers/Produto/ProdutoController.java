package com.gestao.back.controllers.Produto;
...
public class ProdutoController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ProdutoResponseDTO> movimentarEstoque(@PathVariable Long id, @Valid @RequestBody MovimentoEstoqueRequestDTO dto) {
